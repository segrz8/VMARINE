...
const Dockmate = () => {
    return (
        <div className="dockmate">
            ...
            <h2>Aktualnie system dockmate obsługuje następujące manetki:</h2>
            <ul>
            ...
            <h2>Aktualnie obsługiwane systemy sterowania sterami strumieniowymi:</h2>
            <ul>
                <li>Uniwersalne</li>
            ...
            <p>Lista obsługiwanych systemów ciągle się powiększa. W razie wątpliwości dzwoń i pytaj!
